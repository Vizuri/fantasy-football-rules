...
[condition]And that statistic is for year {year:[0-9]{4}}=$playStat.year == {year}
[condition]And the statistic quantity is more than {quantity:[0-9]{1,4}}=$playStat.statisticValue > {quantity}
