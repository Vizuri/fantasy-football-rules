...
[condition]When there is a play statistic of type {statType:ENUM:PlayStatistic.statisticType} for year {year:[0-9]{4}} with statistic value greater than {upperLimit:[0-9]{1,4}}=$playStat : PlayStatistic( statisticType == {statType}, year == {year}, statisticValue > {upperLimit} )
